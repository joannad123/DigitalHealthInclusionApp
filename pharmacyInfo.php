...
<form id="pharmacy" name="pharmacy" method="post">
    ...
    <h2>They are ranked in order of site that provides the most information before the process begins.</h2>
    ...
    <div class = "pharmacyMenu">
        ...
        <table id="webTable">
            ...
            <tr>
                <td>1.Boots</td>
                <td>Provides lots of information in a clear manner before anything is done.</td>
            ...
            <tr>
                ...
                <td>Provides a lot of information before the process begins.</td>
            ...
            <tr>
                ...
                <td>Provides limited information before the process begins.</td>
