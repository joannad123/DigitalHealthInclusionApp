...
<h2>They are ranked in order of site that has most consistent styles and colours.</h2>
<div class = "cancerMenu">
    ...
    <table id="webTable">
        ...
        <tr>
            ...
            <td>Uses colour scheme of pink and orange throughout, with a white background.</td>
        ...
        <tr>
            ...
            <td>Uses colour scheme of green throughout, with a white background.</td>
        ...
        <tr>
            ...
            <td>Uses colour scheme of pink throughout, with a white background.</td>
